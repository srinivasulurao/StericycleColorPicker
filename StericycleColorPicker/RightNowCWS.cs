namespace MyUtilities
{
    ...
    public class RightNowCWS
    {
        ...
        private static volatile RightNowCWS _sxmCACWSinstance = null;
        private static object syncSXMCARoot = new Object();

        public event QueryReturnedRowsEventHandler onQueryReturnedRows;

        //Double checked locking is supported by .NET
        public static RightNowCWS GetInstance(IGlobalContext _globalContext)
        {
            if (_sxmCACWSinstance == null)
            {
                lock (syncSXMCARoot)
                {
                    if (_sxmCACWSinstance == null)
                    {
                        /*_sxmCACWSinstance = new SXMCACWS(ServerSettings.Instance.SXMCASOAPUser, ServerSettings.Instance.SXMCASOAPPW, cwsURL); */
                        _sxmCACWSinstance = new RightNowCWS(_globalContext);
                    }
                }
            }

            return _sxmCACWSinstance;
        }
        public RightNowCWS(IGlobalContext globalContext)
        {
            ...
            this._cih.AppID = "SXMCA Staff Account Import";
            this.AssociateCWSToCBO();
        }

        public RightNowCWS(string username, string password, string cwsURL = "")
        {
            this.MetaDataCache = new Dictionary<string, MetaDataClass>();
            this.GeneralCache = new Dictionary<string, object>();
        ...
        public DataTable quickQuery(string query, int limit = 0x2710, bool autoPaginate = true, QueryReturnedRowsEventHandler perQueryEventHandler = null, DataTable dtReturn = null)
        {
            ...
            while (flag)
            {
                ...
                {
                    Console.WriteLine("QueryCSV Error: " + exception.Message);
                }
                if (autoPaginate)
                {
        ...
        public class CustomObject
        {
            ...
            private RightNowCWS cwsInstance;
            ...
            public CustomObject(RightNowCWS CWSInstance, string CustomObjectName, int LoadID = 0)
            {
        ...
        public class CustomObjectBatch
        {
            ...
            private RightNowCWS soap;
            private List<GenericObject> updateObjects = new List<GenericObject>();
            private UpdateProcessingOptions upo;

            public CustomObjectBatch(RightNowCWS SoapInstance, bool AutoSave = false, bool ResetOnSave = true)
            {
            ...
            public void Add(RightNowCWS.CustomObject CustomObject, bool InheritProcessingOptions = true)
            {
        ...
        public delegate bool QueryReturnedRowsEventHandler(object sender, RightNowCWS.QueryReturnedRowsEventArgs e);
